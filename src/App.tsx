    ...
    >
          ...
          >
            <div className="drawer-header">
              <div className="drawer-brand">
                ...
                <span className="drawer-title-brand">Tuner Free</span>
              </div>
              <button
      ...
      <footer>
        ...
        <p className="footer-credit" style={{ marginTop: '0.5rem', marginBottom: '1rem', color: 'var(--text-2)', fontSize: '0.8rem', lineHeight: '1.4', maxWidth: '600px', margin: '0.5rem auto 1rem' }}>
          A community project for musicians. An all-in-one tuner for Guitar, Violin, and Thai instruments. Runs entirely on your device — 100% free and ad-free.
        </p>
